...
function DetailContent({ detail, onEdit, onDelete }: DetailContentProps) {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-6 flex justify-end gap-2 border-t pt-4">
        <Button variant="outline" size="sm" onClick={onEdit} aria-label="Edit policy">
          Edit
        </Button>
        <Button
          variant="outline"
...
function ExpandedPolicyRow({ id, onEdit, onDelete }: ExpandedPolicyRowProps) {
  ...
  return <DetailContent detail={data} onEdit={onEdit} onDelete={onDelete} />;
}
